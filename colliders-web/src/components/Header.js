        ...
        <Fragment>
            <header>
                ...
                <nav className='nav-links'>
                    <div>
                        <button onClick={() => { buttonClickHandler('mint') }}>Mint / View</button>
                    </div>
                    <div>
                        <button onClick={() => { buttonClickHandler('roadmap') }}>Roadmap</button>
                    </div>
                    <div>
                        <button className="mktplc-btn">Marketplace</button>
                    </div>
                    <div className='social-media-links'>
                        <div>
                            <a href='https://discord.gg/nBK5nNRtTs' target='_blank' rel='noreferrer'>
                                <img src={discord_white} alt="Discord" />
                            </a>
                        </div>
                        <div>
                            <a href='https://twitter.com/ftmBAYC' target='_blank' rel='noreferrer'>
            ...
            >
                <a href='https://discord.gg/UpY8EYTD3b' target='_blank' rel='noreferrer'>Discord</a>
                <a href='https://twitter.com/ftmBAYC' target='_blank' rel='noreferrer'>Twitter</a>
            </div>}
        </Fragment >
    )
}
